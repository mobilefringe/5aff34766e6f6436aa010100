...
<script>
    define(["Vue", "vuex", "vue!search-component", 'vue!vue-slick', 'js-cookie', 'masonry' , 'vue-masonry-plugin', 'vue-lazy-load'], function(Vue, Vuex, SearchComponent, slick, Cookies, masonry, VueMasonryPlugin, VueLazyload) {
