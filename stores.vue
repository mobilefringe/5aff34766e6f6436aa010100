                ...
                <div class="table-border">
                  ...
                  <ul class="generic-list">
                    ...
                    <li class="storesA store-list-item-odd store-list-item alphabetical" v-for="store in processedStores">
                        <input :id="'storesA-'+store.id" :name="'accordionA-store'+store,id" data-storeid="storesA-14472" data-storename="A&W" data-storex="1402.0" data-storey="776.0" data-id2="14472" type="checkbox" />
