                ...
                <div class="table-border">
                  ...
                  <ul class="generic-list">
                    ...
                    <li class="storesA store-list-item-odd store-list-item alphabetical" v-for="store in processedStores">
                        <input :id="'storesA-'+store.id" :name="'accordionA-store'+store.id" :data-storeid="'storesA-'+store.id" :data-storename="store.name" :data-storex="store.x_coordinate" :data-storey="store.y_coordinate" data-id2="14472" type="checkbox" />
