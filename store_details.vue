    		...
    		<div class="section_content">
    			...
    			<div class="table-border">
    				...
    				<div class="store_map" id="store_details_map">
    					<div class="demo1">
    						<mapplic-png-map ref="pngmap_ref" :height="480" :showPin="true" :hovertip="true" :storelist="allStores" :floorlist="floorList" :svgWidth="property.map_image_width" :svgHeight="property.map_image_height" @updateMap="updatePNGMap"></mapplic-png-map>                
