...
<script>
    define(["Vue", "vuex", "moment", "moment-timezone", "vue-moment", "vue!footer", "vue!concierge_feedback"], function(Vue, Vuex, moment, tz, VueMoment, footerComponent, ConciergeFeedback) {
